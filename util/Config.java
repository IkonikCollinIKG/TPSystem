...
public class Config {
    ...
    public static void TPPointsWriteDefaultFile() {
        ...
        // NamenManager
        config.addDefault("TPPoint.1.name","Port 1");
        config.addDefault("TPPoint.2.name", "Port 2");
        config.addDefault("TPPoint.3.name","Port 3");
        config.addDefault("TPPoint.4.name", "Port 4");
        config.addDefault("TPPoint.5.name","Port 5");
        config.addDefault("TPPoint.6.name", "Port 6");
        config.addDefault("TPPoint.7.name", "Port 7");
